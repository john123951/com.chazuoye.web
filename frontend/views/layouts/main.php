<?php
use frontend\assets\XenonAsset;
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="sidebar-menu toggle-others fixed" style="">
        ...
        <div class="sidebar-menu-inner ps-container ps-active-y">
            ...
            <div class="ps-scrollbar-x-rail" style="display: block; width: 340px; left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="display: inherit; top: 0px; height: 774px; right: 2px;"><div class="ps-scrollbar-y" style="top: 0px; height: 752px;"></div></div></div>
        ...
        <footer class="main-footer sticky footer-type-1" style="">
            ...
            <div class="footer-inner">
                ...
                <div class="footer-text">
                    &copy; <strong>Xenon</strong> <?= date('Y') ?>
